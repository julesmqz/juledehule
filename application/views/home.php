    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <div class="blog-post">
                ...
                <p class="blog-post-meta">Enero 1, 2014</p>
                <div class="blog-post-image" style="background-image: url('/assets/img/entries/ian-schneider-91717.jpg');"></div>
                ...
                <div class="blog-read-more">
                    <a class="btn btn-outline-dark">Leer Más</a>
                </div>
            </div>
            <!-- /.blog-post -->
            ...
            <nav class="blog-pagination">
                <a href="#">
                    ...
                    Entradas viejas</a>
                <a class="disabled" href="#">Entradas recientes
        ...
        <aside class="col-md-4 blog-sidebar">
            <div class="p-3 mb-3 bg-light rounded">
                <h4 class="font-italic">Acerca de
                    <i class="fa fa-question-circle pull-right" aria-hidden="true"></i>
                </h4>
                <p class="mb-0">Jule de Hule es un espacio experimental y exploratorio. Mostrando opiniones más que hechos, dando prioridad
                    a lo subjetivo sobre lo objetivo.</p>
            </div>

            <div class="p-3">
                <h4 class="font-italic">Categorias</h4>
                <ol class="jh-list list-unstyled mb-0">
                    <li>
                        <a href="#">Personal</a>
                    </li>
                    <li>
